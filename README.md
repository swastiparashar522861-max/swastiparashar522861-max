...
`B.Tech` · `Data Analytics` · `Python` · `SQL` · `Power BI`

---

## 👩‍🎓 About Me

I'm a **B.Tech student at Bharati Vidyapeeth College of Engineering, Pune** (Expected 2027), specializing in **Electronics & Telecommunication Engineering**. I transform raw data into actionable insights using Python, SQL, and Power BI.

- 🔍 Passionate about **data-driven decision making**
- 📚 Currently learning: Advanced Statistics & Time Series Forecasting
- 🎯 Goal: Data Analyst driving business impact
- 🎤 Strong communication & event management skills
...
*API data collection · SQLite · Clustering (K-Means) · Time Series Forecasting*

- Collected 23+ education indicators from World Bank API (2000-2023, 200+ countries)
- Performed statistical analysis (correlation, ANOVA, T-tests) & K-Means clustering (k=4)
...
[![Power BI](https://img.shields.io/badge/Power_BI-Dashboard-F2C811?style=flat-square&logo=power-bi)](https://powerbi.microsoft.com/)
[![Random Forest](https://img.shields.io/badge/ML-Random_Forest-F7931E?style=flat-square&logo=scikit-learn)](https://scikit-learn.org/)

*SQL Server ETL · Power BI DAX · Random Forest (82% accuracy)*

- Built ETL pipeline in SQL Server (staging → production tables → views)
- Created interactive Power BI dashboard with KPIs, demographics, churn analysis
- Trained Random Forest model to predict future churners (82% accuracy)
- **Identified key churn drivers:** Tenure, Monthly Charges, Contract Type
...
| :--- | :--- | :--- |
| **Data Science (Elite)** | NPTEL | [![NPTEL](https://img.shields.io/badge/NPTEL-Elite-FF9933?style=flat-square)](https://nptel.ac.in/) |
| **Data Analytics** | Google | [![Google](https://img.shields.io/badge/Google-Data_Analytics-4285F4?style=flat-square)](https://grow.google/) |
| **Excel Mastery** | Udemy | [![Udemy](https://img.shields.io/badge/Udemy-Excel-A435F0?style=flat-square)](https://udemy.com/) |
...
- **Elected Secretary** — IETE Student Group, Bharati Vidyapeeth COE, Pune
  - Organize technical events, manage team communication, administrative operations
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=swastiparashar522861-max&show_icons=true&theme=default&hide=contribs&count_private=true" width="48%" />
  <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=swastiparashar522861-max&layout=compact&theme=default" width="48%" />
</p>

<p align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=swastiparashar522861-max&theme=default" width="50%" />
</p>
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=swastiparashar522861-max&color=blue&style=flat-square" />
</p>
